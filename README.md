...
Dataset: Bike Store Relational Database (link your source, eg Kaggle/Maven Analytics) — 3 stores, ~1,445 customers, 321 products, 1,615 orders, 4,722 order line items.
